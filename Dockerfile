...
RUN apt-get -y install build-essential python3-cffi libcairo2 libpango-1.0-0 libpangocairo-1.0-0 libgdk-pixbuf2.0-0 libffi-dev shared-mime-info nodejs npm
...
RUN echo "conda activate djangoProject2" >> ~/.bashrc
